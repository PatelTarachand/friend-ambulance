                            ...
                            <div class="col-md-4">
                                <div class="card bg-success text-white">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="mb-0">With Background</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                        ...
                                        <div class="card-body">
                                            <?php if ($bg['background_image']): ?>
                                                ...
                                                <div class="d-flex gap-2 mb-3">
                                                    ...
                                                    <form method="POST" class="d-inline">
                                                        ...
                                                        <button type="submit" name="remove_background" class="btn btn-outline-danger btn-sm"
                                                                onclick="return confirm('Remove background image for this slide?')">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    ...
                                                    <?php echo $bg['background_image'] ? 'Replace' : 'Upload'; ?> Background
                                                </button>
                                            </form>
                                        </div>
                                    </div>
